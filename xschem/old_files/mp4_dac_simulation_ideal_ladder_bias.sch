...
.control
  ...
  while code < 128
    ...
    save all
    op
    wrdata ~/Documents/DAC-VLSI/simulation_results/dac_simulation_ideal_ladder_bias.txt v(b0) v(b1) v(b2) v(b3) v(b4) v(b5) v(b6) v(Vout) i(Viin) i(Viout)
    if code eq 0
      set appendwrite
...
C {/home/madvlsi/Documents/DAC-VLSI/xschem/biasGen.sym} 130 -20 0 0 {name=x5}
C {madvlsi/vsource.sym} -100 420 0 0 {name=vdump
value=0.8}
C {madvlsi/gnd.sym} -100 450 0 0 {name=l11 lab=GND}
C {devices/lab_pin.sym} -100 390 2 0 {name=p21 sig_type=std_logic lab=Vdump}
C {devices/lab_pin.sym} 200 110 2 0 {name=p20 sig_type=std_logic lab=Vdump}
