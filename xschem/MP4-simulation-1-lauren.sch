...
.control
  ...
  while code < 128
    ...
    save all
    op
    wrdata ~/Documents/MP4/simulation_L_1.txt v(V0) v(V1) v(V2) v(V3) v(V4) v(V5) v(V6) v(Vout) i(Vout)
    if code eq 0
      set appendwrite
  ...
  quit
.endc"}
C {/home/madvlsi/DAC-VLSI/xschem/ladder.sym} 220 140 0 0 {name=x2}
C {madvlsi/gnd.sym} 130 240 0 0 {name=l10 lab=GND}
