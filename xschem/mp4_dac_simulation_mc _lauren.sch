...
.control
  ...
  let code = 0
   while code < 128
    ...
    save all
    op
    wrdata ~/DAC-VLSI/simulation_results/mc/dac_simulation_mc_lauren_\{$&run\}.txt v(b0) v(b1) v(b2) v(b3) v(b4) v(b5) v(b6) v(vout) i(Viin) i(Viout)
    if code eq 0
      set appendwrite
...
C {devices/lab_pin.sym} 130 40 2 0 {name=p19 sig_type=std_logic lab=VDD}
...
C {/home/madvlsi/DAC-VLSI/xschem/FVF-1.sym} 480 180 0 1 {name=x3}
C {/home/madvlsi/DAC-VLSI/xschem/VGen.sym} 480 160 0 1 {name=x4}
